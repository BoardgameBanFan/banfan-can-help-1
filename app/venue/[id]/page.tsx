...
export default function VenuePage() {
  ...
  const { user } = useUser();
  const { event, games, isLoading, error, joinGame, leaveGame } = useEventDetails(params.id as string);
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-lg p-4 flex items-center space-x-3">
          ...
          <div>
            ...
            {event.fee > 0 && (
              <div className="text-gray-600">費用：${event.fee}</div>
            )}
          </div>
        </div>
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {gameItem.game.min_player}-{gameItem.game.max_player} 人 • {gameItem.game.year_published}
                          </p>
                        </div>
                        <button
                          onClick={() => 
        ...
        <div className="w-[375px] bg-stone-100 p-6 font-sans">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              <img src="https://i.imgur.com/T0FCQxR.png" alt="Scout Game" className="w-20 h-28 rounded-lg object-cover" />
              <div className="flex-1">
                <h2 className="font-bold text-lg">Scout</h2>
                <p className="text-sm mb-2">Poach your opponents' artists and outdo each other's circus shows</p>
                ...
                <div className="flex mt-2 gap-2">
                  <div className="bg-white rounded-full px-3 py-1 flex items-center gap-1 text-sm shadow-sm hover:shadow transition-shadow">
                    <img src="https://i.imgur.com/jN8x0J6.png" alt="James" className="w-5 h-5 rounded-full" />
                    <span>James</span>
                  </div>
                  <div className="bg-white rounded-full px-3 py-1 flex items-center gap-1 text-sm shadow-sm hover:shadow transition-shadow">
                    <img src="https://i.imgur.com/wPFYZKL.png" alt="Kuan" className="w-5 h-5 rounded-full" />
                    <span>Kuan</span>
                  </div>
                  <div className="bg-white rounded-full px-3 py-1 flex items-center gap-1 text-sm shadow-sm hover:shadow transition-shadow">
                    <img src="https://i.imgur.com/7Rmzbdy.png" alt="Lance" className="w-5 h-5 rounded-full" />
                    <span>Lance</span>
                  </div>
                </div>
                <div className="flex mt-2 gap-2">
                  <div className="bg-white rounded-full px-3 py-1 flex items-center gap-1 text-sm shadow-sm hover:shadow transition-shadow">
                    <img src="https://i.imgur.com/qY6ygQR.png" alt="Tiv" className="w-5 h-5 rounded-full" />
                    <span>Tiv</span>
                  </div>
                  <div className="bg-white rounded-full px-3 py-1 flex items-center gap-1 text-sm shadow-sm hover:shadow transition-shadow">
                    <img src="https://i.imgur.com/hGDkeXL.png" alt="Gore" className="w-5 h-5 rounded-full" />
                    <span>Gore</span>
                  </div>
                </div>
              </div>
            ...
            {/* Second Game Card */}
            <div className="flex gap-4">
              <img src="https://i.imgur.com/2BjyeoL.png" alt="Seasons Game" className="w-20 h-28 rounded-lg object-cover" />
              <div className="flex-1">
                <h2 className="font-bold text-lg">Seasons</h2>
                <p className="text-sm mb-2">Mages compete across twelve seasons to collect crystals and become the new archmage.</p>
                <div className="flex gap-2 text-xs mb-2">
                  <span>60 Mins</span>
                  <span className="mx-2">•</span>
            ...
            {/* Third Game Card */}
            <div className="flex gap-4">
              <img src="https://i.imgur.com/sE4Hzpo.png" alt="Trickerion Game" className="w-20 h-28 rounded-lg object-cover" />
              <div className="flex-1">
                <h2 className="font-bold text-lg">Trickerion: Collector's Edition</h2>
                <p className="text-sm mb-2">In a Victorian steampunk world, magicians perform dazzling tricks for money and fame.</p>
                <div className="flex gap-2 text-xs mb-2">
                ...
                <div className="flex mt-2 gap-2">
                  <div className="bg-teal-500 text-white rounded-full px-3 py-1 flex items-center gap-1 text-sm shadow-sm hover:bg-teal-600 transition-colors">
                    <img src="https://i.imgur.com/9wMX3QM.png" alt="You" className="w-5 h-5 rounded-full" />
                    <span>You</span>
                  </div>
                  <div className="bg-white rounded-full px-3 py-1 flex items-center gap-1 text-sm shadow-sm hover:shadow transition-shadow">
                    <img src="https://i.imgur.com/wPFYZKL.png" alt="Kuan" className="w-5 h-5 rounded-full" />
